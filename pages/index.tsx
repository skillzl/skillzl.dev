  ...
  <section className="mb-10 sm:flex sm:items-center sm:justify-between">
    <div className="container mx-auto max-w-sm rounded-lg overflow-hidden shadow-lg my-2 dark:bg-gray-800">
      <div className="relative z-10">
        <Image className="w-full" src={profilePic} alt="Picture of the author" placeholder="blur" quality={85} />
      ...
      <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-green-50">
        <div className="flex flex-row-reverse md:contents">
          <div className="bg-green-500 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            ...
            <p className="leading-tight">
              Working on new projects with more complex infrastructures and more powerful features. Also switched to
              deploy with more modern services.
            </p>
          </div>
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-green-500 col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
            ...
            <p className="leading-tight">
              Started learning <a className="font-bold text-green-900" href="https://reactjs.org/">React</a>. Also I
              made my first attempt to create a new modern website from scratch.
            </p>
          </div>
        </div>
        <div className="flex flex-row-reverse md:contents">
          <div className="bg-green-500 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            ...
            <p className="leading-tight">
              Joined <a className="font-bold text-green-900" href="http://b1gcheats.xyz">b1gcheats.xyz</a> project as
              Lead Developer. Started making more changes to the style I used to code my applications.
            </p>
          </div>
          <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
            <div className="h-full w-6 flex items-center justify-center">
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-green-500 col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
            ...
            <p className="leading-tight">
              At the end of 2018 I started to learn the basic of programming. Started with my first project: <a
                className="font-bold text-green-900" href="http://chrlwv.tech">chrlwv.tech</a> beeing a Discord
