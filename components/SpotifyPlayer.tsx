...
function CurrentlyPlaying({
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-0.5 rounded-md p-1 bg-gray-300 dark:bg-zinc-900 shadow dark:border-gray-600">
        <span
          id="bar1"
          className="block h-5 w-1 rounded bg-green-500 dark:bg-green-500"
        />
        <span
          id="bar2"
          className="block h-5 w-1 rounded bg-green-500 dark:bg-green-500"
