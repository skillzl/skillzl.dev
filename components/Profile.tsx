    ...
    return (
        <section className="mb-10 sm:flex sm:items-center sm:justify-between">
            <div className="container mx-auto max-w-sm rounded-lg overflow-hidden shadow-lg my-2 bg-gray-200 dark:bg-gradient-to-tl from-zinc-900 to-gray-800 border border-[#17182910] backdrop-blur-md">
                ...
                <div className="mt-10 dark:text-blue-50 text-center text-sm">
                    <p>Catalin Turta</p>
                </div>
                <div className="mt-0.5 mb-2 dark:text-blue-50 text-center text-lg">
                    <p>self-taught programmer</p>
                </div>
                <div className="pb-10 text-center tracking-wide flex justify-around">
                    <div className="posts">
                        <p className="bg-gradient-to-r from-purple-400 to-violet-600 bg-clip-text text-transparent text-sm">Repositories</p>
                        {loading ? <p>Loading...</p> : <p className="dark:text-blue-50">{repoCount}</p>}
                    </div>
                    <div className="followers">
                        <p className="bg-gradient-to-r from-purple-400 to-violet-600 bg-clip-text text-transparent text-sm">Experience</p>
                        {loading ? <p>Loading...</p> : <p className="dark:text-blue-50">{yearsOfExperience} years</p>}
                    </div>
